...
export const experiences: Experience[] = [
  ...
  {
    company: "한국핀테크지원센터 X 카카오뱅크",
    companyEn: "Korea Fintech Center × Kakaobank",
    role: "FIN:NECT 챌린지 장려상",
    roleEn: "FIN:NECT Challenge — Encouragement Prize",
    team: "FlowPay 팀",
    teamEn: "FlowPay Team",
    ...
    endDate: "2025-08",
    description: [
      "무기명 법인카드 지출·회계 자동화 B2B SaaS 'FlowPay' PM + 프론트엔드 + IR 피칭 전 역할 수행",
      "102팀 중 5위(장려상) 수상",
      "Flow ID 기반 익명 태깅 시스템 설계, 회계담당자 인터뷰 기반 Pain Point 도출",
    ],
    descriptionEn: [
      "Performed PM, frontend development, and IR pitching for anonymous corporate card B2B SaaS 'FlowPay'",
      "Won 5th place (Encouragement Prize) out of 102 teams",
      "Designed Flow ID-based anonymous tagging; derived Pain Points from accountant interviews",
    ],
    tags: ["B2B SaaS", "React", "FIDO2", "IR", "Fintech"],
  },
  {
