...

  {
    ...
    background: [
      {
        ...
        subItems: [
          {
            text: "React 18 PWA입니다. 2025년 운영 당시 프론트엔드 저장소 커밋 98개 중 60개를 맡았고, 2026.09에는 다음 기수를 위한 출석 관리 개선을 프론트엔드와 백엔드(Spring) 모두 직접 구현해 머지했습니다. 프론트엔드는 배포됐고 서버는 아직 열리기 전입니다.",
            textEn: "A React 18 PWA. During the 2025 run I made 60 of the 98 frontend commits; in Sep 2026 I built attendance-management improvements for the next cohort on both frontend and backend (Spring) and merged them; the frontend is deployed, and the server is not yet running.",
          },
        ],
      },
    ],
    role: [
      ...
      },
      {
        ...
        title: "다음 기수를 위한 출석 관리 개선 — FE·BE 직접 구현, 서버 가동 전",
        titleEn: "Attendance management for the next cohort — FE and BE built myself, server not yet running",
        items: [
          {
          ...
          {
            text: "위 화면의 운영진 통계·QR·내 출석은 서버가 열리기 전이라 예시 데이터로 찍었습니다. 이름과 수치는 실제 기록이 아닙니다.",
            textEn: "The staff statistics, QR, and personal attendance screens above were captured with sample data because the server is not yet running; the names and numbers are not real records.",
          },
        ],
      },
    ],
