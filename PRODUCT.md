...
- Name: 신상현 / Sanghyeon Shin. Positioning line (2026-09-21, v6): 「사용자의 실제 행동에서 답을 찾아, 직접 만들어 배포하는 서비스 기획자」 / "A service planner who finds the answer in what users actually do, then builds and ships." The v6 proof line ("~가 아니라 ~였다" triplet) was retired by v9 (2026-09-22) because it violates the v9 voice rules below; Hero (2026-09-24): the positioning sentence itself is the largest text on the first screen (the "Portfolio" wordmark was removed; "Portfolio 2026" stays in the meta row). Under it, a proof paragraph ties one story together: the community platform used by 2,500+ students across 80 universities (https://likelion.community/, run and planned by him, developed by AXP — never "built it") → the 2,000-person hackathon that registered through it → the FAQ bot, submission checker, and finals console he built and ran on site. Hero numbers are all evidence of those tools in use: 2,000+ · 80.8% (0 of 229 unanswered) · 2.2 s · 5 violating teams from a 562-repo sweep. Markers that must survive any edit: 실제 행동 / 직접 만들어 배포 / 기획부터 본선 운영까지. Planning documents remain a strength; never write "기획서 대신".
